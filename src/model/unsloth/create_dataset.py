...
if __name__ == "__main__":
    ...
    diabetes = load_dataset("passionMan/diabetes_v19", token=huggingface_token)
    ...
    # data classification
    save_json(split_data["group1"]["train"], "test_dataset/data_classification_train.json")
    save_json(split_data["group1"]["test"], "test_dataset/data_classification_test.json")

    # data generation
    save_json(split_data["group2"]["train"], "test_dataset/data_generation_train.json")
    save_json(split_data["group2"]["test"], "test_dataset/data_generation_test.json")
